package com.example.cryptospring.util.crypto.mode;

import static com.example.cryptospring.util.crypto.util.Ops.*;
import com.example.cryptospring.util.crypto.BlockCipher;
import com.example.cryptospring.util.crypto.BlockCipher.Mode;
import com.example.cryptospring.util.crypto.BlockCipherModeBlock;
